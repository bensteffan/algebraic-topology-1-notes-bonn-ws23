...
\begin{definition}
	...
	We define the \strong{tangent bundle}\index{tangent bundle} $\tau_M$ with total space $\Tang M \coloneq \{(x, v) \in M \subseteq \R^m \mid v \in \Tang_x M\}$ to be the projection $\tau_M(x, v) \coloneq x$.
\end{definition}
\begin{lemma}
	\leavevmode
	\begin{enumerate}
